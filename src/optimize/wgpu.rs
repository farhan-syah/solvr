//! WebGPU implementation of optimization algorithms.
...
use crate::optimize::impl_generic::{
...
impl OptimizationAlgorithms<WgpuRuntime> for WgpuClient {
...
mod tests {
    ...
    fn test_bisect_wgpu() {
        ...
        let result = client
            .bisect(|x| x * x - 4.0, 0.0, 3.0, &ScalarOptions::default())
            .unwrap();
